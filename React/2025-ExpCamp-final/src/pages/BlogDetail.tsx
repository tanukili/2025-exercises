...
export default function BlogDetail() {
  ...
  return (
    <>
      <FeaturedArticle />
      <article className="px-3 mt-16 mb-12">
        <section>
          <h2>前言</h2>
          <p>
            嗨，我是
          ...
          <picture>
            ...
            />
            <img src="/mobile/blog-content/content1.png" alt="VScode畫面" />
          </picture>
        </section>
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              <ol>
                ...
                <li>
                  善用<span>CSS-Tricks</span>等資源，了解常見版型技巧。
                </li>
              </ol>
            </li>
            <li>
          ...
          <picture>
            ...
            />
            <img src="/mobile/blog-content/content2.png" alt="coding示意圖" />
          </picture>
        </section>
        <section>
          <h2>擅用主流框架與工具</h2>
          <ul>
            <li>
              ...
              <p>TIP：可以先看官方文件或跟著基礎教學做出小專案，感受哪個框架更順手。</p>
            </li>
            <li>
              <h3>版本控制、協作與建置</h3>
              <ul>
          ...
          <picture>
            ...
            />
            <img src="/mobile/blog-content/content3.png" alt="" />
          </picture>
        </section>
        <section>
          <h2>持續練習與參與社群</h2>
          <ul>
            <li>
              ...
              <ul>
                ...
                <li>像是<span>Frontend Mentor</span>提供多種真實設計稿，可練習切版與互動。</li>
              </ul>
            </li>
            <li>
              <h3>打造個人作品集網站</h3>
          ...
          <picture>
            ...
            />
            <img src="/mobile/blog-content/content4.png" alt="" />
          </picture>
        </section>
        <section>
          <h2></h2>
          <p>自學前端可能遇到卡關、挫折，但同時也具備很高的自主性。只要把 基礎、框架、實踐 三大面向做好，就能在前端這條路上穩步前進。若你在學習過程中需要更多建議或想要職涯諮詢，歡迎透過<a href="mailto:">聯絡方式</a>與我聯繫！<span></span></p>
          <p>「程式替你開路，諮詢替你指路，一起走向更寬廣的未來。」</p>
      ...
      <div className="flex justify-between px-3 mb-16">
        <Link to='/' className="btn-outline flex"><i className="icon icon-page-left mr-1"></i>上一篇</Link>
        <Link to='/' className="btn-outline flex">下一篇<i className="icon icon-page-right ml-1"></i></Link>
      </div>
    </>
  );
}
