                    ...
                    <div className="col-md-8 mb-12 mb-md-9">
                        <div className="d-flex align-items-end mb-4 mb-md-6">
                            ...
                            <button
                                ...
                                type="button"
                            >
                                <span className="material-symbols-outlined fs-5 me-md-1">upload</span>
                                更新頭貼
                            </button>
                        </div>
                        <form className="was-validated">
                            ...
                            <div className="mb-4">
                                ...
                                >
                                    修改密碼
                                    <span className="material-symbols-outlined fs-5 ms-md-1">keyboard_arrow_right</span>
                                </button>
                            </div>
                            <div className="form-floating mb-4 mb-md-6">
                                <input
                                ...
                                <p className="text-natural-50 fs-8 px-2">盡量勿使用Yahoo或Hotmail郵件信箱，以免因擋信、漏信</p>
                                <div className="invalid-feedback">
                                    <div className="d-flex align-items-center">
                                        <span className="material-symbols-outlined me-1 fs-9">error</span>
                                        請輸入您的信箱
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content shadow">
                        ...
                        <div className="modal-footer py-3">
                            ...
                            >
                                更新密碼
                                <span className="material-symbols-outlined fs-5 ms-1">keyboard_arrow_right</span>
                            </button>
                        </div>
                    </div>
                </div>
