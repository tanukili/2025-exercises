export default function FeaturedArticle() {
  ...
  return (
    <section className="lg:flex lg:h-[640px]">
      <picture className="block lg:w-1/2 lg:pr-3 lg:-mr-3">
        <source
      ...
      <div className="border-b-2 border-secondary lg:grow lg:grid">
        <div className="px-3 py-12 lg:place-self-center lg:ml-3 lg:pr-0 lg:max-w-648 lg:mr-auto">
